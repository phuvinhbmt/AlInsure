...
//        });
    ...
    public void homeActionPerformed(java.awt.event.ActionEvent evt) {                                     
        All_Insure.quest.emptyAllBut(0);
        All_Insure.quest.setVisible(true);
        All_Insure.quote.setVisible(false);
        All_Insure.reset();
    }                                    

    private void carActionPerformed(java.awt.event.ActionEvent evt) {                                    
        All_Insure.quest.emptyAllBut(2);
        All_Insure.quest.setVisible(true);
        All_Insure.quote.setVisible(false);
        All_Insure.reset();
    }                                   
    ...
    private void contentsActionPerformed(java.awt.event.ActionEvent evt) {                                         
        All_Insure.quest.emptyAllBut(1);
        All_Insure.quest.setVisible(true);
        All_Insure.quote.setVisible(false);
        All_Insure.reset();
    }                                        
